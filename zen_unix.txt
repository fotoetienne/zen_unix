# Zen and the Art of Programming Simply
*the Unix philosophy*
---
            ...
            \__,_|_||_\__,_|  \__|_||_\___| \__,_|_|  \__| \___/_|
                                         _                _            _      
 _ __ _ _ ___  __ _ _ _ __ _ _ __  _ __ (_)_ _  __ _   __(_)_ __  _ __| |_  _ 
| '_ \ '_/ _ \/ _` | '_/ _` | '  \| '  \| | ' \/ _` | (_-< | '  \| '_ \ | || |
| .__/_| \___/\__, |_| \__,_|_|_|_|_|_|_|_|_||_\__, | /__/_|_|_|_| .__/_|\_, |
|_|           |___/                            |___/             |_|     |__/ 
...
"Does Unix have a philosophy? I thought it just had a dismissive attitude and a drinking problem."
 - L Martin
...
- Originated by Ken Thompson (Bell labs, Google, Plan 9, regex, grep, utf-8, go)
- Emphasizes short, simple, clear, modular, and extensible code
- Has evolved over time, not a formal design method
- Not just for Unix!

;;- just a set of guidelines
;;- Some are recognized as best practices, some are controversial.
...
---
  ...
  _.._ :`4MM$!YYYYYYYYYii,.__.diii$$YYYYYYYYYYY      such beautiful
